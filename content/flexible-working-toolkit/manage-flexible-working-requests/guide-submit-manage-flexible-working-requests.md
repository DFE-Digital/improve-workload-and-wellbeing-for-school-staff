---
title: Step by step guide showing how to submit and manage flexible working requests
colour: blue
---
...
<div class="info-box">
  ...
  <div class="govuk-grid-row info-box__download-content">
    <div class="govuk-grid-column-one-half">
      <img src="/assets/images/guide-submit-manage-flexible-working-requests-thumbnail.png" alt="Thumbnail of guide to submitting and managing flexible working requests example " class="dfe-file-preview-image">
    </div>

    <div class="govuk-grid-column-one-half">
      <a class="govuk-body" href="<%= @base_url %>/assets/files/guide-submit-manage-flexible-working-requests.docx">
