---
title: Identify issues using a staff wellbeing survey
colour: blue
---
...
<div class="info-box">
  ...
  <p>
    ...
    <a href="https://forms.office.com/Pages/ShareFormPage.aspx?id=yXfS-grGoU2187O4s0qC-Qr38U5q_SNAjFOmwHLgkAJUQ1pUWFQyS1ZRT1ZURTMzSkhOQjFMRkI2NS4u&sharetoken=WXvyoJwmzPMPC0SGMlDL" class="govuk-link">
      this online version
    </a>
    of the staff wellbeing survey.
  </p>
  ...
  <div class="govuk-grid-row info-box__download-content">
    <div class="govuk-grid-column-one-half">
      <img src="/assets/images/workplace-wellbeing-survey-preview.png" alt="Workplace wellbeing survey preview" class="dfe-file-preview-image">
    </div>

    <div class="govuk-grid-column-one-half">
      <a class="govuk-body" href="<%= @base_url %>/assets/files/workplace-wellbeing-survey.docx">
      ...
      <a class="govuk-body" href="<%= @base_url %>/assets/files/workplace-wellbeing-survey.odt">
...
You can address wellbeing issues you identify using resources from across this website, however the list is not exhaustive. You can help other school leaders by [sharing what has worked in your school](https://improve-workload-and-wellbeing-for-school-staff.education.gov.uk/share-your-ideas/).
