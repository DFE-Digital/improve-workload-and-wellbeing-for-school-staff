---
title: Create your own wellbeing charter commitments
colour: blue
---
...
<div class="info-box">
  ...
  <ul>
    <li>clear responsibilities and commitments to wellbeing for staff at all levels;</li>
    <li>greater staff awareness of the wellbeing support on offer; and</li>
    <li>positive staff feedback on the school culture.</li>
  </ul>
  ...
  <ul>
    <li>improved engagement scores in staff surveys; and</li>
    <li>a reduction in staff absences and in staff turnover.</li>
  </ul>
</div>
...
<div class="info-box">
  ...
  <div class="govuk-grid-row info-box__download-content">
    <div class="govuk-grid-column-one-half">
      <img src="/assets/images/preview-wellbeing-charter.png" alt="Wellbeing charter preview" class="dfe-file-preview-image">
    </div>

    <div class="govuk-grid-column-one-half">
      <div class="info-box__content">
        <a class="govuk-body" href="<%= @base_url %>/assets/files/wellbeing-charter.docx">
          Download Microsoft Word Document
        </a>
        <p>
          DOCX, 84KB, 1 page
        </p>
        <a class="govuk-body" href="<%= @base_url %>/assets/files/wellbeing-charter.odt">
